    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="nav nav-tabs ml-auto">
        ...
        <div class="dropdown">
            ...
            <li class="nav-item ">
              <a class="nav-link active js-scroll-trigger" href="about.php"><i class="fa fa-fw fa-address-card"></i>About Us</a>
            </li>
            <li class="nav-item">
  ...
  <section id="about">
    <div class="container">
      ...
      <div class="row justify-content-center fs-5 text-center">
        <div class="col-md-4">
          <p>Malang Agro Travel adalah sebuah website yang dibuat di tahun 2020 untuk membantu para wisatawan yang ingin ke kota Malang dan mencari tempat wisata bernuansa alam</p>
        </div>
      </div>
    </div>
  </section>
